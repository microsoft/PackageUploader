...
/// host routes a public service call through the real pipeline to the in-memory Ingestion fake with
/// the fake auth token attached.
/// </summary>
[TestClass]
public sealed class SmokeTest : IntegrationTestBase
{
    [TestMethod]
    public async Task TestHost_RoutesProductLookup_ThroughFakeWithFakeAuth()
    {
