...
private:
    ...
    static constexpr int   NUM_CHANNELS = 8;   // polyphony
    static constexpr int   BPM = 128;
    ...
    static constexpr int   NUM_TRACKS = 6;     // parallel tracks
    ...
    struct Pattern
    {
        NoteEvent notes[16][6]; // [row][track]
    };
