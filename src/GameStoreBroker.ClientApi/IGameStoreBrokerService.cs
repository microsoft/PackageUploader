...
namespace GameStoreBroker.ClientApi
{
    public interface IGameStoreBrokerService
    {
        ...
        Task<GamePackageConfiguration> SetUwpConfigurationAsync(GameProduct product, GamePackageBranch packageBranch, string marketGroupId, GameConfiguration gameConfiguration, CancellationToken ct);
        ...
        Task<GamePackageConfiguration> ImportPackagesAsync(GameProduct product, GamePackageBranch originPackageBranch, GamePackageBranch destinationPackageBranch, string marketGroupId, bool overwrite, GameConfiguration gameConfiguration, CancellationToken ct);
    }
}
