...
namespace GameStoreBroker.ClientApi
{
    public interface IGameStoreBrokerService
    {
        ...
        Task<GamePackageConfiguration> SetUwpPackageDatesAsync(GameProduct product, GamePackageBranch packageBranch, string marketGroupId, GamePackageDates gamePackageDates, CancellationToken ct);
        ...
        Task<GamePackageConfiguration> ImportPackagesAsync(GameProduct product, GamePackageBranch originPackageBranch, GamePackageBranch destinationPackageBranch, string marketGroupId, bool overwrite, GamePackageDates gamePackageDates, CancellationToken ct);
    }
}
