...
public static class IngestionExtensions
{
    ...
    /// <summary>UploadSource value for the Package Uploader CLI.</summary>
    public const string PackageUploaderUploadSource = UploadSourceConfig.PackageUploaderSource;
    ...
    private static IServiceCollection AddIngestionAuthentication(this IServiceCollection services, 
        ...
        authenticationMethod switch
        {
            ...
            AuthenticationMethod.ManagedIdentityFederated => services.AddManagedIdentityFederatedCredentialAccessTokenProvider(),
